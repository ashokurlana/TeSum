...
from . import config_tel as config
from . import data
...
class Batcher(object):
  BATCH_QUEUE_MAX = 100 #1000 # max number of batches the batch_queue can hold
  def __init__(self, data_path, vocab, mode, batch_size, single_pass):
    ...
    #print("_batch_queue = ",self._batch_queue.qsize())
    self._example_queue = Queue.Queue(self.BATCH_QUEUE_MAX * self.batch_size)
    #print("self._example_queue = ",self._example_queue.qsize())
  ...
  def fill_example_queue(self):
    ...
    #print("input_gen:",type(input_gen))
    while True:
      try:
  ...
  def fill_batch_queue(self):
    while True:
      if self.mode == 'decode':
        ...
        #print("# of batches: ",len(batches[0]),type(batches))
        #print(batches)
  ...
  def text_generator(self, example_generator):
    while True:
      ...
      try:
        ...
        #print("# of articles: ",type(article_text),len(article_text))
        #print("\n")
