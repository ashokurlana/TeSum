...
finished_path = "telugu_data/finished"
unfinished_path = "telugu_data/unfinished"
chunk_path = "telugu_data/chunked"

vocab_path = "telugu_data/vocab"

VOCAB_SIZE = 200000 #500000 

CHUNK_SIZE = 100 #15000 # num examples per chunk, for the chunked data
...
#test_bin_path2 = os.path.join(finished_path, "test2.bin")
