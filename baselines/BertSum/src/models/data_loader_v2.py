...
def load_dataset(args, corpus_type, shuffle):
    ...
    print("args.bert_data_path : ",args.bert_data_path)
    print("corpus_type: ",corpus_type)
    print("full path: ",args.bert_data_path + '.' + corpus_type + '.[0-9]*.bert.pt')
    print("\n")
    #pts = sorted(glob.glob(args.bert_data_path + '.' + corpus_type + '.[0-9]*.pt'))
    #print("** : ",args.bert_data_path + 'cnndm.' + corpus_type + '.[0-9]*.bert.pt')
    ...
    if pts:
        ...
        pt = args.bert_data_path + 'cnndm.' + corpus_type + '.bert.pt'
