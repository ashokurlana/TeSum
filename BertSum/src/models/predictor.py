...
class Translator(object):
    ...
    def __init__(self,
        ...
        self.args = args
        #print("Translator self.args  :",self.args)
        self.model = model
        self.generator = self.model.generator
        self.vocab = vocab
        self.symbols = symbols

        self.start_token = symbols['CLS'] #symbols['BOS']
        self.end_token = symbols['SEP'] #symbols['EOS']
    ...
    def _build_target_tokens(self, pred):
        ...
        for tok in pred:
            ...
            ###### As we dont have 'EOS'special token in ltrc_bert so;
    ...
    def _fast_translate_batch(self,
        ...
        #alive_seq = torch.full([batch_size * beam_size, 1],dtype=torch.long, device=device)
...
#            topk_beam_index = topk_ids.div(vocab_size)
            ...
            is_finished = topk_ids.eq(self.end_token) ## As we dont have end_token='EOS'special token in ltrc_bert so NEED TO FIX THIS PROBLEM ;
