...
#sys.path.append("/home/ravva_priyanka/Summarization/get_to_point_model_1/training_ptr_gen/data_util/config.py")
#sys.path.append("/home/ravva_priyanka/Summarization/get_to_point_model_1/training_ptr_gen/data_util/data.py")
...
class Batch(object):
  ...
  def init_encoder_seq(self, example_list):
    ...
    #print("init_encoder_seq ....")
    #print("max_enc_seq_len : ",max_enc_seq_len)
  ...
  def store_orig_strings(self, example_list):
    ...
    #print("store_orig_strings ...")
    #print("original_articles : ",len(self.original_articles))
    #print("original_abstracts : ",len(self.original_abstracts))
    #print("\n")
...
class Batcher(object):
  ...
  def __init__(self, data_path, vocab, mode, batch_size, single_pass):
    ...
    #print("mode, batch_size, single_pass: ",mode, batch_size, single_pass)
  ...
  def next_batch(self):
    #print("In next_batch function ... self._batch_queue.qsize() = ",self._batch_queue.qsize())
  ...
  def fill_batch_queue(self):
    while True:
      if self.mode == 'decode':
        ...
        batches = []
        #print("0, len(inputs), self.batch_size : ",0, len(inputs), self.batch_size)
        ...
        for i,b in enumerate(batches):  # each b is a list of Example objects
          self._batch_queue.put(Batch(b, self._vocab, self.batch_size))
          #print("batches iteration i, b , self._batch_queue.qsize(): ",i, len(b), self._batch_queue.qsize())
 
        #print("self._batch_queue.qsize(): ",self._batch_queue.qsize())
        #print("\n")
